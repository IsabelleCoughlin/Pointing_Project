...
# Load the CSV file
data = pd.read_csv('/Users/isabe/Downloads/dummy_raster_02') 
...
for index, row in data.iterrows():
    ...
    # Append power value along with Az Off and El Off
    ...
    az_index = current_az_off + (grid_size // 2)  # Shift values to start from 0
    el_index = current_el_off + (grid_size // 2)  # Shift values to start from 0
